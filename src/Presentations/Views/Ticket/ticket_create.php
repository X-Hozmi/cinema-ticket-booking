...
<body>
    <div class="container">
        ...
        <form id="ticketForm" action="../../Handlers/Ticket/ticket_store.php" method="post">
            ...
            <div class="form-group">
                <select id="idprice" name="idprice" required>
                    ...
                    <?php foreach ($priceList as $price): ?>
                        <option value="<?= $price['idprice'] ?>" data-price="<?= $price['total_price'] ?>">
            ...
            <div class="form-group input-group-icon">
                ...
                <input type="number" id="total_price" name="total_price" placeholder="Total Harga" required readonly>
            </div>

            <button type="submit" class="btn" id="submitBtn" disabled>Simpan</button>
        </form>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function updateBookedSeatsAndGrid() {
                try {
                    const response = await fetch(`../../Handlers/Ticket/get_booked_seats.php?jadwal_id=${jadwalSelect.value}`);
                    const data = await response.json();
